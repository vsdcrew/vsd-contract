...
contract MockUniswapV2PairTrade is IUniswapV2Pair {
    ...
    constructor (address tokenA, address tokenB) public {
        _token0 = tokenA < tokenB ? tokenA : tokenB;
        _token1 = tokenA < tokenB ? tokenB : tokenA;
    }

    function simulateTrade(address dollar, uint112 newReserveA, uint112 newReserveB) external {
        uint112 newReserve0 = _token0 == dollar ? newReserveA : newReserveB;
        uint112 newReserve1 = _token0 == dollar ? newReserveB : newReserveA;
